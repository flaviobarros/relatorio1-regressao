...
yl <- ylab ('Residuals')
p1 <-  ggplot(both , aes( x = ajustado , y = residuo)) + geom_point() + yl
p2 <- ggplot(both , aes( x = cimento , y = residuo )) + geom_point() + yl
p3 <- ggplot(both , aes( x = dia , y = residuo )) + yl + ylim ( -100 , 100) +
stat_summary(fun.data = "mean_sdl", geom = 'smooth', fun)
p4 <- ggplot(both , aes(sample = residuo)) + stat_qq() +

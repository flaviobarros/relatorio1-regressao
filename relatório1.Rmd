...
### utilizando mesmo modelo que foi utilizado para a análise de multicolinearidade, não temos nenhum ponto que possa ser considerado um outlier
...
for (f in formulas) {
  ...
  treinoPredNorm <- predict(model_norm, treino)
...
final_model <- lm(formula = f2_log, data = treino)
